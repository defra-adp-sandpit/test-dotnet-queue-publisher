...
using Test.Dotnet.Queue.Publisher.Api.Extensions;
using Test.Dotnet.Queue.Publisher.Api.HealthChecks;
...
namespace Test.Dotnet.Queue.Publisher.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Dotnet.Queue.Publisher", Version = "v1" });
        });
